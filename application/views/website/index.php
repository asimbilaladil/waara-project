    <!-- Banner Start --> 
    <div class="page-section" style="background:url(<?php echo base_url("includes/website/assets/extra-images/banner-img.jpg") ?> ) no-repeat;background-size:cover;padding:212px 0;">
        <div class="container">
            <div class="row">
                ...
                <div class="page-content col-lg-9 col-md-9 col-sm-12 col-xs-12">
                  <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="cs-courses courses-grid">
                            <div class="cs-media">
                                <figure><a href="#"><img src="assets/extra-images/course-grid-img4.jpg" alt=""/></a></figure>
                            </div>
                            <div class="cs-text">
                                <div class="cs-rating">
                                  <div class="cs-rating-star">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="cs-courses courses-grid">
                            <div class="cs-media">
                                <figure><a href="#"><img src="assets/extra-images/course-grid-img5.jpg" alt=""/></a></figure>
                            </div>
                            <div class="cs-text">
                                <span class="cs-caption">CC</span>
                                <div class="cs-rating">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="cs-courses courses-grid">
                            <div class="cs-media">
                                <figure><a href="#"><img src="assets/extra-images/course-grid-img6.jpg" alt=""/></a></figure>
                            </div>
                            <div class="cs-text">
                                <div class="cs-rating">
                                  <div class="cs-rating-star">
        ...
        <div class="page-section" style="margin-bottom:90px;">
            <ul class="row cs-history-slider">
                 <li class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
                     <div class="cs-media">
                         <figure>
                             <img src="assets/extra-images/history-01.jpg" alt="" />
                 ...
                 <li class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
                     <div class="cs-media">
                         <figure>
                             <img src="assets/extra-images/history-02.jpg" alt="" />
                 ...
                 <li class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
                     <div class="cs-media">
                         <figure>
                             <img src="assets/extra-images/history-03.jpg" alt="" />
                 ...
                 <li class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
                     <div class="cs-media">
                         <figure>
                             <img src="assets/extra-images/history-04.jpg" alt="" />
                 ...
                 <li class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
                     <div class="cs-media">
                         <figure>
                             <img src="assets/extra-images/history-05.jpg" alt="" />
