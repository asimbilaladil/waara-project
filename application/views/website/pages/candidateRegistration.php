        ...
        <div class="row">
            <div class="col-md-12">
                <div class="product-bit-title text-center">
                    <h2>Registration form for candidates</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="product-content-right">
                    <div class="woocommerce-info">Already Registered?? <a href="<?php echo site_url('Login') ?>">Click
                            here to login</a>
                    </div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3 registration">
                ...
                <form class="form-horizontal" id="defaultForm" action="<?php echo site_url('welcome/saveCandidate') ?>"
                      method="post">
