            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-success">
                        ...
                        <!-- form start -->
                        <form id="defaultForm" class="form-horizontal" action="<?php echo site_url('Admin/updateCategory') ?>" method="post" >
                            <div class="box-body">

                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Name</label>
                                    <div class="col-sm-6">
                                        <input type="text" name="cat_name" class="form-control" id="" placeholder="" value="<?php echo $category['cat_name']?>">
