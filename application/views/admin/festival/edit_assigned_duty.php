            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-success">
                        ...
                        <!-- form start -->
                        <form id="defaultForm" class="form-horizontal" action="<?php echo site_url('Festival/updateAssignedDuty') ?>" method="post" >
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="hidden" id="selectedUser" name="selectedUser" value="<?php echo $item->user_id?>" /> 
...
<!--                                 <div class="form-group">
                                ...
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-2">
                                        ...
                                        <button type="button" onclick="deleteAssignDuty(<?php echo $this->input->get('id') ?>)" class="btn btn-primary btn-block">Delete</button>
                                    </div> 
                                </div>
                            </div><!-- /.box-body -->
...
function deleteAssignDuty(id) {

    var assignId = id;
    $.ajax({
        url: "<?php echo site_url('Festival/deleteAssignDuty') ?>",
        type: "POST",
        data: {
            'id' : assignId
        },
